...
<div style="background-color: #1D1D2F;" class="min-h-screen text-white flex flex-col">
    ...
    <div class="bg-[#141326] px-6 py-6">
        <div class="flex items-center justify-between w-full">
            ...
            <div class="flex items-center gap-6">
                ...
                <a href="/register" class="bg-[#ff9c00] text-black px-4 py-2 rounded-full font-bold 
                transition-all duration-200 hover:brightness-110">{{ __('auth.signup') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-6 py-6 flex-1 flex items-center justify-center">
        ...
        <div class="flex items-center justify-center gap-3 mb-4">
            ...
            <h2 class="text-xl font-bold text-[#f89c00] tracking-wider 
            uppercase">{{ __('auth.snf_title') }}</h2>
        </div>
