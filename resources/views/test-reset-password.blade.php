...
<div class="absolute left-1/2 transform -translate-x-1/2 w-full mb-8" style="top: 30px">
    <x-authentication-card>
        <x-slot name="logo">
            <head>
                <title>{{ __('auth.reset_password_header') }}</title>
                <style>
        ...
        <form method="POST" action="#" class="bg-[#3c3f58] flex flex-col items-center justify-center w-full max-w-4xl mx-auto rounded-4xl px-8 py-2 pb-6 space-y-8">
